...
// VARIANT: bf16_shuffle — truncf-before-shuffle with packed i32 cross-lane exchange.
//
...
//
// EPILOGUE OPTIMIZATION vs mxfp4_epilogue_opt_256x192x256.mlir:
//   Original: 4 × gpu.shuffle xor on f32 per MFMA group (one per accumulator row).
//   This:     2 × gpu.shuffle xor on i32 per MFMA group — halves cross-lane traffic.
//
//   Per group, the new pattern is:
//     1. arith.truncf [row0,row1] → vector<2xbf16>  (v_cvt_pk_bf16_f32)
//        arith.truncf [row2,row3] → vector<2xbf16>  (v_cvt_pk_bf16_f32)
//     2. arith.bitcast → i32  (free / same register)
//     3. 2 × gpu.shuffle xor on i32  (carries 2 bf16 values per shuffle)
//     4. arith.select  src_lo = is_even ? pair01_own : pair23_nbr
//                      src_hi = is_even ? pair01_nbr : pair23_own
//     5. Reconstruct store_a / store_b via bit-ops:
//          store_a = (src_lo & 0xFFFF) | ((src_hi & 0xFFFF) << 16)
//          store_b = (src_lo >> 16)    |  (src_hi & 0xFFFF0000)
//     6. arith.bitcast back to vector<2xbf16> and vector.store
//
//   Correctness proof (lane pair L even, L+1 odd):
//     pair01_L   = [bf16(row0_L), bf16(row1_L)]  (i32 low16=row0, high16=row1)
//     pair23_L   = [bf16(row2_L), bf16(row3_L)]
//     After shuffle: pair01_nbr_L  = pair01_{L+1}, pair23_nbr_L = pair23_{L+1}
//     Even (is_even=T): src_lo=pair01_L, src_hi=pair01_{L+1}
//       store_a = [bf16(row0_L), bf16(row0_{L+1})]  ✓  (same as original)
//       store_b = [bf16(row1_L), bf16(row1_{L+1})]  ✓
//     Odd (is_even=F): src_lo=pair23_{L} (=pair23_nbr of odd), src_hi=pair23_{L+1}
//       store_a = [bf16(row2_L), bf16(row2_{L+1})]  ✓
//       store_b = [bf16(row3_L), bf16(row3_{L+1})]  ✓
//
...
stream.executable private @gemm {
    ...
    func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding, %arg3: !stream.binding, %arg4: !stream.binding, %arg5: index, %arg6: index, %arg7: index, %arg8: index, %arg9: index, %arg10: index, %arg11: index, %arg12: index) attributes {translation_info = #translation} {
        ...
        %ep_c_0xFFFF     = arith.constant 65535 : i32
        %ep_c_0xFFFF0000 = arith.constant 4294901760 : i32
        %ep_c_16         = arith.constant 16 : i32
        ...
        %ep_v209_pair01_vec0 = vector.broadcast %ep_v209_row0 : f32 to vector<2xf32>
        %ep_v209_pair01_vec  = vector.insert %ep_v209_row1, %ep_v209_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v209_pair01_bf16 = arith.truncf %ep_v209_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v209_pair23_vec0 = vector.broadcast %ep_v209_row2 : f32 to vector<2xf32>
        %ep_v209_pair23_vec  = vector.insert %ep_v209_row3, %ep_v209_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v209_pair23_bf16 = arith.truncf %ep_v209_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v209_pair01_i32_v1i32 = vector.bitcast %ep_v209_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v209_pair01_i32 = vector.extract %ep_v209_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v209_pair23_i32_v1i32 = vector.bitcast %ep_v209_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v209_pair23_i32 = vector.extract %ep_v209_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v209_pair01_nbr, %ep_v209_pair01_valid = gpu.shuffle xor %ep_v209_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v209_pair23_nbr, %ep_v209_pair23_valid = gpu.shuffle xor %ep_v209_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v209_src_lo = arith.select %ep_is_even, %ep_v209_pair01_i32, %ep_v209_pair23_nbr : i32
        %ep_v209_src_hi = arith.select %ep_is_even, %ep_v209_pair01_nbr, %ep_v209_pair23_i32 : i32
        %ep_v209_sa_lo   = arith.andi %ep_v209_src_lo, %ep_c_0xFFFF : i32
        %ep_v209_sa_hi16 = arith.andi %ep_v209_src_hi, %ep_c_0xFFFF : i32
        %ep_v209_sa_hi   = arith.shli %ep_v209_sa_hi16, %ep_c_16 : i32
        %ep_v209_store_a_i32 = arith.ori %ep_v209_sa_lo, %ep_v209_sa_hi : i32
        %ep_v209_sb_lo = arith.shrui %ep_v209_src_lo, %ep_c_16 : i32
        %ep_v209_sb_hi = arith.andi %ep_v209_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v209_store_b_i32 = arith.ori %ep_v209_sb_lo, %ep_v209_sb_hi : i32
        %ep_v209_store_a_v1i32 = vector.broadcast %ep_v209_store_a_i32 : i32 to vector<1xi32>
        %ep_v209_store_a = vector.bitcast %ep_v209_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v209_store_b_v1i32 = vector.broadcast %ep_v209_store_b_i32 : i32 to vector<1xi32>
        %ep_v209_store_b = vector.bitcast %ep_v209_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v211_pair01_vec0 = vector.broadcast %ep_v211_row0 : f32 to vector<2xf32>
        %ep_v211_pair01_vec  = vector.insert %ep_v211_row1, %ep_v211_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v211_pair01_bf16 = arith.truncf %ep_v211_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v211_pair23_vec0 = vector.broadcast %ep_v211_row2 : f32 to vector<2xf32>
        %ep_v211_pair23_vec  = vector.insert %ep_v211_row3, %ep_v211_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v211_pair23_bf16 = arith.truncf %ep_v211_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v211_pair01_i32_v1i32 = vector.bitcast %ep_v211_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v211_pair01_i32 = vector.extract %ep_v211_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v211_pair23_i32_v1i32 = vector.bitcast %ep_v211_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v211_pair23_i32 = vector.extract %ep_v211_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v211_pair01_nbr, %ep_v211_pair01_valid = gpu.shuffle xor %ep_v211_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v211_pair23_nbr, %ep_v211_pair23_valid = gpu.shuffle xor %ep_v211_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v211_src_lo = arith.select %ep_is_even, %ep_v211_pair01_i32, %ep_v211_pair23_nbr : i32
        %ep_v211_src_hi = arith.select %ep_is_even, %ep_v211_pair01_nbr, %ep_v211_pair23_i32 : i32
        %ep_v211_sa_lo   = arith.andi %ep_v211_src_lo, %ep_c_0xFFFF : i32
        %ep_v211_sa_hi16 = arith.andi %ep_v211_src_hi, %ep_c_0xFFFF : i32
        %ep_v211_sa_hi   = arith.shli %ep_v211_sa_hi16, %ep_c_16 : i32
        %ep_v211_store_a_i32 = arith.ori %ep_v211_sa_lo, %ep_v211_sa_hi : i32
        %ep_v211_sb_lo = arith.shrui %ep_v211_src_lo, %ep_c_16 : i32
        %ep_v211_sb_hi = arith.andi %ep_v211_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v211_store_b_i32 = arith.ori %ep_v211_sb_lo, %ep_v211_sb_hi : i32
        %ep_v211_store_a_v1i32 = vector.broadcast %ep_v211_store_a_i32 : i32 to vector<1xi32>
        %ep_v211_store_a = vector.bitcast %ep_v211_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v211_store_b_v1i32 = vector.broadcast %ep_v211_store_b_i32 : i32 to vector<1xi32>
        %ep_v211_store_b = vector.bitcast %ep_v211_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v213_pair01_vec0 = vector.broadcast %ep_v213_row0 : f32 to vector<2xf32>
        %ep_v213_pair01_vec  = vector.insert %ep_v213_row1, %ep_v213_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v213_pair01_bf16 = arith.truncf %ep_v213_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v213_pair23_vec0 = vector.broadcast %ep_v213_row2 : f32 to vector<2xf32>
        %ep_v213_pair23_vec  = vector.insert %ep_v213_row3, %ep_v213_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v213_pair23_bf16 = arith.truncf %ep_v213_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v213_pair01_i32_v1i32 = vector.bitcast %ep_v213_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v213_pair01_i32 = vector.extract %ep_v213_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v213_pair23_i32_v1i32 = vector.bitcast %ep_v213_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v213_pair23_i32 = vector.extract %ep_v213_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v213_pair01_nbr, %ep_v213_pair01_valid = gpu.shuffle xor %ep_v213_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v213_pair23_nbr, %ep_v213_pair23_valid = gpu.shuffle xor %ep_v213_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v213_src_lo = arith.select %ep_is_even, %ep_v213_pair01_i32, %ep_v213_pair23_nbr : i32
        %ep_v213_src_hi = arith.select %ep_is_even, %ep_v213_pair01_nbr, %ep_v213_pair23_i32 : i32
        %ep_v213_sa_lo   = arith.andi %ep_v213_src_lo, %ep_c_0xFFFF : i32
        %ep_v213_sa_hi16 = arith.andi %ep_v213_src_hi, %ep_c_0xFFFF : i32
        %ep_v213_sa_hi   = arith.shli %ep_v213_sa_hi16, %ep_c_16 : i32
        %ep_v213_store_a_i32 = arith.ori %ep_v213_sa_lo, %ep_v213_sa_hi : i32
        %ep_v213_sb_lo = arith.shrui %ep_v213_src_lo, %ep_c_16 : i32
        %ep_v213_sb_hi = arith.andi %ep_v213_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v213_store_b_i32 = arith.ori %ep_v213_sb_lo, %ep_v213_sb_hi : i32
        %ep_v213_store_a_v1i32 = vector.broadcast %ep_v213_store_a_i32 : i32 to vector<1xi32>
        %ep_v213_store_a = vector.bitcast %ep_v213_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v213_store_b_v1i32 = vector.broadcast %ep_v213_store_b_i32 : i32 to vector<1xi32>
        %ep_v213_store_b = vector.bitcast %ep_v213_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v215_pair01_vec0 = vector.broadcast %ep_v215_row0 : f32 to vector<2xf32>
        %ep_v215_pair01_vec  = vector.insert %ep_v215_row1, %ep_v215_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v215_pair01_bf16 = arith.truncf %ep_v215_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v215_pair23_vec0 = vector.broadcast %ep_v215_row2 : f32 to vector<2xf32>
        %ep_v215_pair23_vec  = vector.insert %ep_v215_row3, %ep_v215_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v215_pair23_bf16 = arith.truncf %ep_v215_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v215_pair01_i32_v1i32 = vector.bitcast %ep_v215_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v215_pair01_i32 = vector.extract %ep_v215_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v215_pair23_i32_v1i32 = vector.bitcast %ep_v215_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v215_pair23_i32 = vector.extract %ep_v215_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v215_pair01_nbr, %ep_v215_pair01_valid = gpu.shuffle xor %ep_v215_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v215_pair23_nbr, %ep_v215_pair23_valid = gpu.shuffle xor %ep_v215_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v215_src_lo = arith.select %ep_is_even, %ep_v215_pair01_i32, %ep_v215_pair23_nbr : i32
        %ep_v215_src_hi = arith.select %ep_is_even, %ep_v215_pair01_nbr, %ep_v215_pair23_i32 : i32
        %ep_v215_sa_lo   = arith.andi %ep_v215_src_lo, %ep_c_0xFFFF : i32
        %ep_v215_sa_hi16 = arith.andi %ep_v215_src_hi, %ep_c_0xFFFF : i32
        %ep_v215_sa_hi   = arith.shli %ep_v215_sa_hi16, %ep_c_16 : i32
        %ep_v215_store_a_i32 = arith.ori %ep_v215_sa_lo, %ep_v215_sa_hi : i32
        %ep_v215_sb_lo = arith.shrui %ep_v215_src_lo, %ep_c_16 : i32
        %ep_v215_sb_hi = arith.andi %ep_v215_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v215_store_b_i32 = arith.ori %ep_v215_sb_lo, %ep_v215_sb_hi : i32
        %ep_v215_store_a_v1i32 = vector.broadcast %ep_v215_store_a_i32 : i32 to vector<1xi32>
        %ep_v215_store_a = vector.bitcast %ep_v215_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v215_store_b_v1i32 = vector.broadcast %ep_v215_store_b_i32 : i32 to vector<1xi32>
        %ep_v215_store_b = vector.bitcast %ep_v215_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v217_pair01_vec0 = vector.broadcast %ep_v217_row0 : f32 to vector<2xf32>
        %ep_v217_pair01_vec  = vector.insert %ep_v217_row1, %ep_v217_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v217_pair01_bf16 = arith.truncf %ep_v217_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v217_pair23_vec0 = vector.broadcast %ep_v217_row2 : f32 to vector<2xf32>
        %ep_v217_pair23_vec  = vector.insert %ep_v217_row3, %ep_v217_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v217_pair23_bf16 = arith.truncf %ep_v217_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v217_pair01_i32_v1i32 = vector.bitcast %ep_v217_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v217_pair01_i32 = vector.extract %ep_v217_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v217_pair23_i32_v1i32 = vector.bitcast %ep_v217_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v217_pair23_i32 = vector.extract %ep_v217_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v217_pair01_nbr, %ep_v217_pair01_valid = gpu.shuffle xor %ep_v217_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v217_pair23_nbr, %ep_v217_pair23_valid = gpu.shuffle xor %ep_v217_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v217_src_lo = arith.select %ep_is_even, %ep_v217_pair01_i32, %ep_v217_pair23_nbr : i32
        %ep_v217_src_hi = arith.select %ep_is_even, %ep_v217_pair01_nbr, %ep_v217_pair23_i32 : i32
        %ep_v217_sa_lo   = arith.andi %ep_v217_src_lo, %ep_c_0xFFFF : i32
        %ep_v217_sa_hi16 = arith.andi %ep_v217_src_hi, %ep_c_0xFFFF : i32
        %ep_v217_sa_hi   = arith.shli %ep_v217_sa_hi16, %ep_c_16 : i32
        %ep_v217_store_a_i32 = arith.ori %ep_v217_sa_lo, %ep_v217_sa_hi : i32
        %ep_v217_sb_lo = arith.shrui %ep_v217_src_lo, %ep_c_16 : i32
        %ep_v217_sb_hi = arith.andi %ep_v217_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v217_store_b_i32 = arith.ori %ep_v217_sb_lo, %ep_v217_sb_hi : i32
        %ep_v217_store_a_v1i32 = vector.broadcast %ep_v217_store_a_i32 : i32 to vector<1xi32>
        %ep_v217_store_a = vector.bitcast %ep_v217_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v217_store_b_v1i32 = vector.broadcast %ep_v217_store_b_i32 : i32 to vector<1xi32>
        %ep_v217_store_b = vector.bitcast %ep_v217_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v219_pair01_vec0 = vector.broadcast %ep_v219_row0 : f32 to vector<2xf32>
        %ep_v219_pair01_vec  = vector.insert %ep_v219_row1, %ep_v219_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v219_pair01_bf16 = arith.truncf %ep_v219_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v219_pair23_vec0 = vector.broadcast %ep_v219_row2 : f32 to vector<2xf32>
        %ep_v219_pair23_vec  = vector.insert %ep_v219_row3, %ep_v219_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v219_pair23_bf16 = arith.truncf %ep_v219_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v219_pair01_i32_v1i32 = vector.bitcast %ep_v219_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v219_pair01_i32 = vector.extract %ep_v219_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v219_pair23_i32_v1i32 = vector.bitcast %ep_v219_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v219_pair23_i32 = vector.extract %ep_v219_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v219_pair01_nbr, %ep_v219_pair01_valid = gpu.shuffle xor %ep_v219_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v219_pair23_nbr, %ep_v219_pair23_valid = gpu.shuffle xor %ep_v219_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v219_src_lo = arith.select %ep_is_even, %ep_v219_pair01_i32, %ep_v219_pair23_nbr : i32
        %ep_v219_src_hi = arith.select %ep_is_even, %ep_v219_pair01_nbr, %ep_v219_pair23_i32 : i32
        %ep_v219_sa_lo   = arith.andi %ep_v219_src_lo, %ep_c_0xFFFF : i32
        %ep_v219_sa_hi16 = arith.andi %ep_v219_src_hi, %ep_c_0xFFFF : i32
        %ep_v219_sa_hi   = arith.shli %ep_v219_sa_hi16, %ep_c_16 : i32
        %ep_v219_store_a_i32 = arith.ori %ep_v219_sa_lo, %ep_v219_sa_hi : i32
        %ep_v219_sb_lo = arith.shrui %ep_v219_src_lo, %ep_c_16 : i32
        %ep_v219_sb_hi = arith.andi %ep_v219_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v219_store_b_i32 = arith.ori %ep_v219_sb_lo, %ep_v219_sb_hi : i32
        %ep_v219_store_a_v1i32 = vector.broadcast %ep_v219_store_a_i32 : i32 to vector<1xi32>
        %ep_v219_store_a = vector.bitcast %ep_v219_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v219_store_b_v1i32 = vector.broadcast %ep_v219_store_b_i32 : i32 to vector<1xi32>
        %ep_v219_store_b = vector.bitcast %ep_v219_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v221_pair01_vec0 = vector.broadcast %ep_v221_row0 : f32 to vector<2xf32>
        %ep_v221_pair01_vec  = vector.insert %ep_v221_row1, %ep_v221_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v221_pair01_bf16 = arith.truncf %ep_v221_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v221_pair23_vec0 = vector.broadcast %ep_v221_row2 : f32 to vector<2xf32>
        %ep_v221_pair23_vec  = vector.insert %ep_v221_row3, %ep_v221_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v221_pair23_bf16 = arith.truncf %ep_v221_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v221_pair01_i32_v1i32 = vector.bitcast %ep_v221_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v221_pair01_i32 = vector.extract %ep_v221_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v221_pair23_i32_v1i32 = vector.bitcast %ep_v221_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v221_pair23_i32 = vector.extract %ep_v221_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v221_pair01_nbr, %ep_v221_pair01_valid = gpu.shuffle xor %ep_v221_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v221_pair23_nbr, %ep_v221_pair23_valid = gpu.shuffle xor %ep_v221_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v221_src_lo = arith.select %ep_is_even, %ep_v221_pair01_i32, %ep_v221_pair23_nbr : i32
        %ep_v221_src_hi = arith.select %ep_is_even, %ep_v221_pair01_nbr, %ep_v221_pair23_i32 : i32
        %ep_v221_sa_lo   = arith.andi %ep_v221_src_lo, %ep_c_0xFFFF : i32
        %ep_v221_sa_hi16 = arith.andi %ep_v221_src_hi, %ep_c_0xFFFF : i32
        %ep_v221_sa_hi   = arith.shli %ep_v221_sa_hi16, %ep_c_16 : i32
        %ep_v221_store_a_i32 = arith.ori %ep_v221_sa_lo, %ep_v221_sa_hi : i32
        %ep_v221_sb_lo = arith.shrui %ep_v221_src_lo, %ep_c_16 : i32
        %ep_v221_sb_hi = arith.andi %ep_v221_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v221_store_b_i32 = arith.ori %ep_v221_sb_lo, %ep_v221_sb_hi : i32
        %ep_v221_store_a_v1i32 = vector.broadcast %ep_v221_store_a_i32 : i32 to vector<1xi32>
        %ep_v221_store_a = vector.bitcast %ep_v221_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v221_store_b_v1i32 = vector.broadcast %ep_v221_store_b_i32 : i32 to vector<1xi32>
        %ep_v221_store_b = vector.bitcast %ep_v221_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v223_pair01_vec0 = vector.broadcast %ep_v223_row0 : f32 to vector<2xf32>
        %ep_v223_pair01_vec  = vector.insert %ep_v223_row1, %ep_v223_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v223_pair01_bf16 = arith.truncf %ep_v223_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v223_pair23_vec0 = vector.broadcast %ep_v223_row2 : f32 to vector<2xf32>
        %ep_v223_pair23_vec  = vector.insert %ep_v223_row3, %ep_v223_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v223_pair23_bf16 = arith.truncf %ep_v223_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v223_pair01_i32_v1i32 = vector.bitcast %ep_v223_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v223_pair01_i32 = vector.extract %ep_v223_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v223_pair23_i32_v1i32 = vector.bitcast %ep_v223_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v223_pair23_i32 = vector.extract %ep_v223_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v223_pair01_nbr, %ep_v223_pair01_valid = gpu.shuffle xor %ep_v223_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v223_pair23_nbr, %ep_v223_pair23_valid = gpu.shuffle xor %ep_v223_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v223_src_lo = arith.select %ep_is_even, %ep_v223_pair01_i32, %ep_v223_pair23_nbr : i32
        %ep_v223_src_hi = arith.select %ep_is_even, %ep_v223_pair01_nbr, %ep_v223_pair23_i32 : i32
        %ep_v223_sa_lo   = arith.andi %ep_v223_src_lo, %ep_c_0xFFFF : i32
        %ep_v223_sa_hi16 = arith.andi %ep_v223_src_hi, %ep_c_0xFFFF : i32
        %ep_v223_sa_hi   = arith.shli %ep_v223_sa_hi16, %ep_c_16 : i32
        %ep_v223_store_a_i32 = arith.ori %ep_v223_sa_lo, %ep_v223_sa_hi : i32
        %ep_v223_sb_lo = arith.shrui %ep_v223_src_lo, %ep_c_16 : i32
        %ep_v223_sb_hi = arith.andi %ep_v223_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v223_store_b_i32 = arith.ori %ep_v223_sb_lo, %ep_v223_sb_hi : i32
        %ep_v223_store_a_v1i32 = vector.broadcast %ep_v223_store_a_i32 : i32 to vector<1xi32>
        %ep_v223_store_a = vector.bitcast %ep_v223_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v223_store_b_v1i32 = vector.broadcast %ep_v223_store_b_i32 : i32 to vector<1xi32>
        %ep_v223_store_b = vector.bitcast %ep_v223_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v225_pair01_vec0 = vector.broadcast %ep_v225_row0 : f32 to vector<2xf32>
        %ep_v225_pair01_vec  = vector.insert %ep_v225_row1, %ep_v225_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v225_pair01_bf16 = arith.truncf %ep_v225_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v225_pair23_vec0 = vector.broadcast %ep_v225_row2 : f32 to vector<2xf32>
        %ep_v225_pair23_vec  = vector.insert %ep_v225_row3, %ep_v225_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v225_pair23_bf16 = arith.truncf %ep_v225_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v225_pair01_i32_v1i32 = vector.bitcast %ep_v225_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v225_pair01_i32 = vector.extract %ep_v225_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v225_pair23_i32_v1i32 = vector.bitcast %ep_v225_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v225_pair23_i32 = vector.extract %ep_v225_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v225_pair01_nbr, %ep_v225_pair01_valid = gpu.shuffle xor %ep_v225_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v225_pair23_nbr, %ep_v225_pair23_valid = gpu.shuffle xor %ep_v225_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v225_src_lo = arith.select %ep_is_even, %ep_v225_pair01_i32, %ep_v225_pair23_nbr : i32
        %ep_v225_src_hi = arith.select %ep_is_even, %ep_v225_pair01_nbr, %ep_v225_pair23_i32 : i32
        %ep_v225_sa_lo   = arith.andi %ep_v225_src_lo, %ep_c_0xFFFF : i32
        %ep_v225_sa_hi16 = arith.andi %ep_v225_src_hi, %ep_c_0xFFFF : i32
        %ep_v225_sa_hi   = arith.shli %ep_v225_sa_hi16, %ep_c_16 : i32
        %ep_v225_store_a_i32 = arith.ori %ep_v225_sa_lo, %ep_v225_sa_hi : i32
        %ep_v225_sb_lo = arith.shrui %ep_v225_src_lo, %ep_c_16 : i32
        %ep_v225_sb_hi = arith.andi %ep_v225_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v225_store_b_i32 = arith.ori %ep_v225_sb_lo, %ep_v225_sb_hi : i32
        %ep_v225_store_a_v1i32 = vector.broadcast %ep_v225_store_a_i32 : i32 to vector<1xi32>
        %ep_v225_store_a = vector.bitcast %ep_v225_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v225_store_b_v1i32 = vector.broadcast %ep_v225_store_b_i32 : i32 to vector<1xi32>
        %ep_v225_store_b = vector.bitcast %ep_v225_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v227_pair01_vec0 = vector.broadcast %ep_v227_row0 : f32 to vector<2xf32>
        %ep_v227_pair01_vec  = vector.insert %ep_v227_row1, %ep_v227_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v227_pair01_bf16 = arith.truncf %ep_v227_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v227_pair23_vec0 = vector.broadcast %ep_v227_row2 : f32 to vector<2xf32>
        %ep_v227_pair23_vec  = vector.insert %ep_v227_row3, %ep_v227_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v227_pair23_bf16 = arith.truncf %ep_v227_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v227_pair01_i32_v1i32 = vector.bitcast %ep_v227_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v227_pair01_i32 = vector.extract %ep_v227_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v227_pair23_i32_v1i32 = vector.bitcast %ep_v227_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v227_pair23_i32 = vector.extract %ep_v227_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v227_pair01_nbr, %ep_v227_pair01_valid = gpu.shuffle xor %ep_v227_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v227_pair23_nbr, %ep_v227_pair23_valid = gpu.shuffle xor %ep_v227_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v227_src_lo = arith.select %ep_is_even, %ep_v227_pair01_i32, %ep_v227_pair23_nbr : i32
        %ep_v227_src_hi = arith.select %ep_is_even, %ep_v227_pair01_nbr, %ep_v227_pair23_i32 : i32
        %ep_v227_sa_lo   = arith.andi %ep_v227_src_lo, %ep_c_0xFFFF : i32
        %ep_v227_sa_hi16 = arith.andi %ep_v227_src_hi, %ep_c_0xFFFF : i32
        %ep_v227_sa_hi   = arith.shli %ep_v227_sa_hi16, %ep_c_16 : i32
        %ep_v227_store_a_i32 = arith.ori %ep_v227_sa_lo, %ep_v227_sa_hi : i32
        %ep_v227_sb_lo = arith.shrui %ep_v227_src_lo, %ep_c_16 : i32
        %ep_v227_sb_hi = arith.andi %ep_v227_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v227_store_b_i32 = arith.ori %ep_v227_sb_lo, %ep_v227_sb_hi : i32
        %ep_v227_store_a_v1i32 = vector.broadcast %ep_v227_store_a_i32 : i32 to vector<1xi32>
        %ep_v227_store_a = vector.bitcast %ep_v227_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v227_store_b_v1i32 = vector.broadcast %ep_v227_store_b_i32 : i32 to vector<1xi32>
        %ep_v227_store_b = vector.bitcast %ep_v227_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v229_pair01_vec0 = vector.broadcast %ep_v229_row0 : f32 to vector<2xf32>
        %ep_v229_pair01_vec  = vector.insert %ep_v229_row1, %ep_v229_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v229_pair01_bf16 = arith.truncf %ep_v229_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v229_pair23_vec0 = vector.broadcast %ep_v229_row2 : f32 to vector<2xf32>
        %ep_v229_pair23_vec  = vector.insert %ep_v229_row3, %ep_v229_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v229_pair23_bf16 = arith.truncf %ep_v229_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v229_pair01_i32_v1i32 = vector.bitcast %ep_v229_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v229_pair01_i32 = vector.extract %ep_v229_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v229_pair23_i32_v1i32 = vector.bitcast %ep_v229_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v229_pair23_i32 = vector.extract %ep_v229_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v229_pair01_nbr, %ep_v229_pair01_valid = gpu.shuffle xor %ep_v229_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v229_pair23_nbr, %ep_v229_pair23_valid = gpu.shuffle xor %ep_v229_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v229_src_lo = arith.select %ep_is_even, %ep_v229_pair01_i32, %ep_v229_pair23_nbr : i32
        %ep_v229_src_hi = arith.select %ep_is_even, %ep_v229_pair01_nbr, %ep_v229_pair23_i32 : i32
        %ep_v229_sa_lo   = arith.andi %ep_v229_src_lo, %ep_c_0xFFFF : i32
        %ep_v229_sa_hi16 = arith.andi %ep_v229_src_hi, %ep_c_0xFFFF : i32
        %ep_v229_sa_hi   = arith.shli %ep_v229_sa_hi16, %ep_c_16 : i32
        %ep_v229_store_a_i32 = arith.ori %ep_v229_sa_lo, %ep_v229_sa_hi : i32
        %ep_v229_sb_lo = arith.shrui %ep_v229_src_lo, %ep_c_16 : i32
        %ep_v229_sb_hi = arith.andi %ep_v229_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v229_store_b_i32 = arith.ori %ep_v229_sb_lo, %ep_v229_sb_hi : i32
        %ep_v229_store_a_v1i32 = vector.broadcast %ep_v229_store_a_i32 : i32 to vector<1xi32>
        %ep_v229_store_a = vector.bitcast %ep_v229_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v229_store_b_v1i32 = vector.broadcast %ep_v229_store_b_i32 : i32 to vector<1xi32>
        %ep_v229_store_b = vector.bitcast %ep_v229_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v231_pair01_vec0 = vector.broadcast %ep_v231_row0 : f32 to vector<2xf32>
        %ep_v231_pair01_vec  = vector.insert %ep_v231_row1, %ep_v231_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v231_pair01_bf16 = arith.truncf %ep_v231_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v231_pair23_vec0 = vector.broadcast %ep_v231_row2 : f32 to vector<2xf32>
        %ep_v231_pair23_vec  = vector.insert %ep_v231_row3, %ep_v231_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v231_pair23_bf16 = arith.truncf %ep_v231_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v231_pair01_i32_v1i32 = vector.bitcast %ep_v231_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v231_pair01_i32 = vector.extract %ep_v231_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v231_pair23_i32_v1i32 = vector.bitcast %ep_v231_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v231_pair23_i32 = vector.extract %ep_v231_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v231_pair01_nbr, %ep_v231_pair01_valid = gpu.shuffle xor %ep_v231_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v231_pair23_nbr, %ep_v231_pair23_valid = gpu.shuffle xor %ep_v231_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v231_src_lo = arith.select %ep_is_even, %ep_v231_pair01_i32, %ep_v231_pair23_nbr : i32
        %ep_v231_src_hi = arith.select %ep_is_even, %ep_v231_pair01_nbr, %ep_v231_pair23_i32 : i32
        %ep_v231_sa_lo   = arith.andi %ep_v231_src_lo, %ep_c_0xFFFF : i32
        %ep_v231_sa_hi16 = arith.andi %ep_v231_src_hi, %ep_c_0xFFFF : i32
        %ep_v231_sa_hi   = arith.shli %ep_v231_sa_hi16, %ep_c_16 : i32
        %ep_v231_store_a_i32 = arith.ori %ep_v231_sa_lo, %ep_v231_sa_hi : i32
        %ep_v231_sb_lo = arith.shrui %ep_v231_src_lo, %ep_c_16 : i32
        %ep_v231_sb_hi = arith.andi %ep_v231_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v231_store_b_i32 = arith.ori %ep_v231_sb_lo, %ep_v231_sb_hi : i32
        %ep_v231_store_a_v1i32 = vector.broadcast %ep_v231_store_a_i32 : i32 to vector<1xi32>
        %ep_v231_store_a = vector.bitcast %ep_v231_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v231_store_b_v1i32 = vector.broadcast %ep_v231_store_b_i32 : i32 to vector<1xi32>
        %ep_v231_store_b = vector.bitcast %ep_v231_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v233_pair01_vec0 = vector.broadcast %ep_v233_row0 : f32 to vector<2xf32>
        %ep_v233_pair01_vec  = vector.insert %ep_v233_row1, %ep_v233_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v233_pair01_bf16 = arith.truncf %ep_v233_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v233_pair23_vec0 = vector.broadcast %ep_v233_row2 : f32 to vector<2xf32>
        %ep_v233_pair23_vec  = vector.insert %ep_v233_row3, %ep_v233_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v233_pair23_bf16 = arith.truncf %ep_v233_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v233_pair01_i32_v1i32 = vector.bitcast %ep_v233_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v233_pair01_i32 = vector.extract %ep_v233_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v233_pair23_i32_v1i32 = vector.bitcast %ep_v233_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v233_pair23_i32 = vector.extract %ep_v233_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v233_pair01_nbr, %ep_v233_pair01_valid = gpu.shuffle xor %ep_v233_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v233_pair23_nbr, %ep_v233_pair23_valid = gpu.shuffle xor %ep_v233_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v233_src_lo = arith.select %ep_is_even, %ep_v233_pair01_i32, %ep_v233_pair23_nbr : i32
        %ep_v233_src_hi = arith.select %ep_is_even, %ep_v233_pair01_nbr, %ep_v233_pair23_i32 : i32
        %ep_v233_sa_lo   = arith.andi %ep_v233_src_lo, %ep_c_0xFFFF : i32
        %ep_v233_sa_hi16 = arith.andi %ep_v233_src_hi, %ep_c_0xFFFF : i32
        %ep_v233_sa_hi   = arith.shli %ep_v233_sa_hi16, %ep_c_16 : i32
        %ep_v233_store_a_i32 = arith.ori %ep_v233_sa_lo, %ep_v233_sa_hi : i32
        %ep_v233_sb_lo = arith.shrui %ep_v233_src_lo, %ep_c_16 : i32
        %ep_v233_sb_hi = arith.andi %ep_v233_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v233_store_b_i32 = arith.ori %ep_v233_sb_lo, %ep_v233_sb_hi : i32
        %ep_v233_store_a_v1i32 = vector.broadcast %ep_v233_store_a_i32 : i32 to vector<1xi32>
        %ep_v233_store_a = vector.bitcast %ep_v233_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v233_store_b_v1i32 = vector.broadcast %ep_v233_store_b_i32 : i32 to vector<1xi32>
        %ep_v233_store_b = vector.bitcast %ep_v233_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v235_pair01_vec0 = vector.broadcast %ep_v235_row0 : f32 to vector<2xf32>
        %ep_v235_pair01_vec  = vector.insert %ep_v235_row1, %ep_v235_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v235_pair01_bf16 = arith.truncf %ep_v235_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v235_pair23_vec0 = vector.broadcast %ep_v235_row2 : f32 to vector<2xf32>
        %ep_v235_pair23_vec  = vector.insert %ep_v235_row3, %ep_v235_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v235_pair23_bf16 = arith.truncf %ep_v235_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v235_pair01_i32_v1i32 = vector.bitcast %ep_v235_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v235_pair01_i32 = vector.extract %ep_v235_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v235_pair23_i32_v1i32 = vector.bitcast %ep_v235_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v235_pair23_i32 = vector.extract %ep_v235_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v235_pair01_nbr, %ep_v235_pair01_valid = gpu.shuffle xor %ep_v235_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v235_pair23_nbr, %ep_v235_pair23_valid = gpu.shuffle xor %ep_v235_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v235_src_lo = arith.select %ep_is_even, %ep_v235_pair01_i32, %ep_v235_pair23_nbr : i32
        %ep_v235_src_hi = arith.select %ep_is_even, %ep_v235_pair01_nbr, %ep_v235_pair23_i32 : i32
        %ep_v235_sa_lo   = arith.andi %ep_v235_src_lo, %ep_c_0xFFFF : i32
        %ep_v235_sa_hi16 = arith.andi %ep_v235_src_hi, %ep_c_0xFFFF : i32
        %ep_v235_sa_hi   = arith.shli %ep_v235_sa_hi16, %ep_c_16 : i32
        %ep_v235_store_a_i32 = arith.ori %ep_v235_sa_lo, %ep_v235_sa_hi : i32
        %ep_v235_sb_lo = arith.shrui %ep_v235_src_lo, %ep_c_16 : i32
        %ep_v235_sb_hi = arith.andi %ep_v235_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v235_store_b_i32 = arith.ori %ep_v235_sb_lo, %ep_v235_sb_hi : i32
        %ep_v235_store_a_v1i32 = vector.broadcast %ep_v235_store_a_i32 : i32 to vector<1xi32>
        %ep_v235_store_a = vector.bitcast %ep_v235_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v235_store_b_v1i32 = vector.broadcast %ep_v235_store_b_i32 : i32 to vector<1xi32>
        %ep_v235_store_b = vector.bitcast %ep_v235_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v237_pair01_vec0 = vector.broadcast %ep_v237_row0 : f32 to vector<2xf32>
        %ep_v237_pair01_vec  = vector.insert %ep_v237_row1, %ep_v237_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v237_pair01_bf16 = arith.truncf %ep_v237_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v237_pair23_vec0 = vector.broadcast %ep_v237_row2 : f32 to vector<2xf32>
        %ep_v237_pair23_vec  = vector.insert %ep_v237_row3, %ep_v237_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v237_pair23_bf16 = arith.truncf %ep_v237_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v237_pair01_i32_v1i32 = vector.bitcast %ep_v237_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v237_pair01_i32 = vector.extract %ep_v237_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v237_pair23_i32_v1i32 = vector.bitcast %ep_v237_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v237_pair23_i32 = vector.extract %ep_v237_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v237_pair01_nbr, %ep_v237_pair01_valid = gpu.shuffle xor %ep_v237_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v237_pair23_nbr, %ep_v237_pair23_valid = gpu.shuffle xor %ep_v237_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v237_src_lo = arith.select %ep_is_even, %ep_v237_pair01_i32, %ep_v237_pair23_nbr : i32
        %ep_v237_src_hi = arith.select %ep_is_even, %ep_v237_pair01_nbr, %ep_v237_pair23_i32 : i32
        %ep_v237_sa_lo   = arith.andi %ep_v237_src_lo, %ep_c_0xFFFF : i32
        %ep_v237_sa_hi16 = arith.andi %ep_v237_src_hi, %ep_c_0xFFFF : i32
        %ep_v237_sa_hi   = arith.shli %ep_v237_sa_hi16, %ep_c_16 : i32
        %ep_v237_store_a_i32 = arith.ori %ep_v237_sa_lo, %ep_v237_sa_hi : i32
        %ep_v237_sb_lo = arith.shrui %ep_v237_src_lo, %ep_c_16 : i32
        %ep_v237_sb_hi = arith.andi %ep_v237_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v237_store_b_i32 = arith.ori %ep_v237_sb_lo, %ep_v237_sb_hi : i32
        %ep_v237_store_a_v1i32 = vector.broadcast %ep_v237_store_a_i32 : i32 to vector<1xi32>
        %ep_v237_store_a = vector.bitcast %ep_v237_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v237_store_b_v1i32 = vector.broadcast %ep_v237_store_b_i32 : i32 to vector<1xi32>
        %ep_v237_store_b = vector.bitcast %ep_v237_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v239_pair01_vec0 = vector.broadcast %ep_v239_row0 : f32 to vector<2xf32>
        %ep_v239_pair01_vec  = vector.insert %ep_v239_row1, %ep_v239_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v239_pair01_bf16 = arith.truncf %ep_v239_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v239_pair23_vec0 = vector.broadcast %ep_v239_row2 : f32 to vector<2xf32>
        %ep_v239_pair23_vec  = vector.insert %ep_v239_row3, %ep_v239_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v239_pair23_bf16 = arith.truncf %ep_v239_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v239_pair01_i32_v1i32 = vector.bitcast %ep_v239_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v239_pair01_i32 = vector.extract %ep_v239_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v239_pair23_i32_v1i32 = vector.bitcast %ep_v239_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v239_pair23_i32 = vector.extract %ep_v239_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v239_pair01_nbr, %ep_v239_pair01_valid = gpu.shuffle xor %ep_v239_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v239_pair23_nbr, %ep_v239_pair23_valid = gpu.shuffle xor %ep_v239_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v239_src_lo = arith.select %ep_is_even, %ep_v239_pair01_i32, %ep_v239_pair23_nbr : i32
        %ep_v239_src_hi = arith.select %ep_is_even, %ep_v239_pair01_nbr, %ep_v239_pair23_i32 : i32
        %ep_v239_sa_lo   = arith.andi %ep_v239_src_lo, %ep_c_0xFFFF : i32
        %ep_v239_sa_hi16 = arith.andi %ep_v239_src_hi, %ep_c_0xFFFF : i32
        %ep_v239_sa_hi   = arith.shli %ep_v239_sa_hi16, %ep_c_16 : i32
        %ep_v239_store_a_i32 = arith.ori %ep_v239_sa_lo, %ep_v239_sa_hi : i32
        %ep_v239_sb_lo = arith.shrui %ep_v239_src_lo, %ep_c_16 : i32
        %ep_v239_sb_hi = arith.andi %ep_v239_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v239_store_b_i32 = arith.ori %ep_v239_sb_lo, %ep_v239_sb_hi : i32
        %ep_v239_store_a_v1i32 = vector.broadcast %ep_v239_store_a_i32 : i32 to vector<1xi32>
        %ep_v239_store_a = vector.bitcast %ep_v239_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v239_store_b_v1i32 = vector.broadcast %ep_v239_store_b_i32 : i32 to vector<1xi32>
        %ep_v239_store_b = vector.bitcast %ep_v239_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v241_pair01_vec0 = vector.broadcast %ep_v241_row0 : f32 to vector<2xf32>
        %ep_v241_pair01_vec  = vector.insert %ep_v241_row1, %ep_v241_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v241_pair01_bf16 = arith.truncf %ep_v241_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v241_pair23_vec0 = vector.broadcast %ep_v241_row2 : f32 to vector<2xf32>
        %ep_v241_pair23_vec  = vector.insert %ep_v241_row3, %ep_v241_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v241_pair23_bf16 = arith.truncf %ep_v241_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v241_pair01_i32_v1i32 = vector.bitcast %ep_v241_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v241_pair01_i32 = vector.extract %ep_v241_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v241_pair23_i32_v1i32 = vector.bitcast %ep_v241_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v241_pair23_i32 = vector.extract %ep_v241_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v241_pair01_nbr, %ep_v241_pair01_valid = gpu.shuffle xor %ep_v241_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v241_pair23_nbr, %ep_v241_pair23_valid = gpu.shuffle xor %ep_v241_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v241_src_lo = arith.select %ep_is_even, %ep_v241_pair01_i32, %ep_v241_pair23_nbr : i32
        %ep_v241_src_hi = arith.select %ep_is_even, %ep_v241_pair01_nbr, %ep_v241_pair23_i32 : i32
        %ep_v241_sa_lo   = arith.andi %ep_v241_src_lo, %ep_c_0xFFFF : i32
        %ep_v241_sa_hi16 = arith.andi %ep_v241_src_hi, %ep_c_0xFFFF : i32
        %ep_v241_sa_hi   = arith.shli %ep_v241_sa_hi16, %ep_c_16 : i32
        %ep_v241_store_a_i32 = arith.ori %ep_v241_sa_lo, %ep_v241_sa_hi : i32
        %ep_v241_sb_lo = arith.shrui %ep_v241_src_lo, %ep_c_16 : i32
        %ep_v241_sb_hi = arith.andi %ep_v241_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v241_store_b_i32 = arith.ori %ep_v241_sb_lo, %ep_v241_sb_hi : i32
        %ep_v241_store_a_v1i32 = vector.broadcast %ep_v241_store_a_i32 : i32 to vector<1xi32>
        %ep_v241_store_a = vector.bitcast %ep_v241_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v241_store_b_v1i32 = vector.broadcast %ep_v241_store_b_i32 : i32 to vector<1xi32>
        %ep_v241_store_b = vector.bitcast %ep_v241_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v243_pair01_vec0 = vector.broadcast %ep_v243_row0 : f32 to vector<2xf32>
        %ep_v243_pair01_vec  = vector.insert %ep_v243_row1, %ep_v243_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v243_pair01_bf16 = arith.truncf %ep_v243_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v243_pair23_vec0 = vector.broadcast %ep_v243_row2 : f32 to vector<2xf32>
        %ep_v243_pair23_vec  = vector.insert %ep_v243_row3, %ep_v243_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v243_pair23_bf16 = arith.truncf %ep_v243_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v243_pair01_i32_v1i32 = vector.bitcast %ep_v243_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v243_pair01_i32 = vector.extract %ep_v243_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v243_pair23_i32_v1i32 = vector.bitcast %ep_v243_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v243_pair23_i32 = vector.extract %ep_v243_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v243_pair01_nbr, %ep_v243_pair01_valid = gpu.shuffle xor %ep_v243_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v243_pair23_nbr, %ep_v243_pair23_valid = gpu.shuffle xor %ep_v243_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v243_src_lo = arith.select %ep_is_even, %ep_v243_pair01_i32, %ep_v243_pair23_nbr : i32
        %ep_v243_src_hi = arith.select %ep_is_even, %ep_v243_pair01_nbr, %ep_v243_pair23_i32 : i32
        %ep_v243_sa_lo   = arith.andi %ep_v243_src_lo, %ep_c_0xFFFF : i32
        %ep_v243_sa_hi16 = arith.andi %ep_v243_src_hi, %ep_c_0xFFFF : i32
        %ep_v243_sa_hi   = arith.shli %ep_v243_sa_hi16, %ep_c_16 : i32
        %ep_v243_store_a_i32 = arith.ori %ep_v243_sa_lo, %ep_v243_sa_hi : i32
        %ep_v243_sb_lo = arith.shrui %ep_v243_src_lo, %ep_c_16 : i32
        %ep_v243_sb_hi = arith.andi %ep_v243_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v243_store_b_i32 = arith.ori %ep_v243_sb_lo, %ep_v243_sb_hi : i32
        %ep_v243_store_a_v1i32 = vector.broadcast %ep_v243_store_a_i32 : i32 to vector<1xi32>
        %ep_v243_store_a = vector.bitcast %ep_v243_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v243_store_b_v1i32 = vector.broadcast %ep_v243_store_b_i32 : i32 to vector<1xi32>
        %ep_v243_store_b = vector.bitcast %ep_v243_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v245_pair01_vec0 = vector.broadcast %ep_v245_row0 : f32 to vector<2xf32>
        %ep_v245_pair01_vec  = vector.insert %ep_v245_row1, %ep_v245_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v245_pair01_bf16 = arith.truncf %ep_v245_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v245_pair23_vec0 = vector.broadcast %ep_v245_row2 : f32 to vector<2xf32>
        %ep_v245_pair23_vec  = vector.insert %ep_v245_row3, %ep_v245_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v245_pair23_bf16 = arith.truncf %ep_v245_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v245_pair01_i32_v1i32 = vector.bitcast %ep_v245_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v245_pair01_i32 = vector.extract %ep_v245_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v245_pair23_i32_v1i32 = vector.bitcast %ep_v245_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v245_pair23_i32 = vector.extract %ep_v245_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v245_pair01_nbr, %ep_v245_pair01_valid = gpu.shuffle xor %ep_v245_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v245_pair23_nbr, %ep_v245_pair23_valid = gpu.shuffle xor %ep_v245_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v245_src_lo = arith.select %ep_is_even, %ep_v245_pair01_i32, %ep_v245_pair23_nbr : i32
        %ep_v245_src_hi = arith.select %ep_is_even, %ep_v245_pair01_nbr, %ep_v245_pair23_i32 : i32
        %ep_v245_sa_lo   = arith.andi %ep_v245_src_lo, %ep_c_0xFFFF : i32
        %ep_v245_sa_hi16 = arith.andi %ep_v245_src_hi, %ep_c_0xFFFF : i32
        %ep_v245_sa_hi   = arith.shli %ep_v245_sa_hi16, %ep_c_16 : i32
        %ep_v245_store_a_i32 = arith.ori %ep_v245_sa_lo, %ep_v245_sa_hi : i32
        %ep_v245_sb_lo = arith.shrui %ep_v245_src_lo, %ep_c_16 : i32
        %ep_v245_sb_hi = arith.andi %ep_v245_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v245_store_b_i32 = arith.ori %ep_v245_sb_lo, %ep_v245_sb_hi : i32
        %ep_v245_store_a_v1i32 = vector.broadcast %ep_v245_store_a_i32 : i32 to vector<1xi32>
        %ep_v245_store_a = vector.bitcast %ep_v245_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v245_store_b_v1i32 = vector.broadcast %ep_v245_store_b_i32 : i32 to vector<1xi32>
        %ep_v245_store_b = vector.bitcast %ep_v245_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v247_pair01_vec0 = vector.broadcast %ep_v247_row0 : f32 to vector<2xf32>
        %ep_v247_pair01_vec  = vector.insert %ep_v247_row1, %ep_v247_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v247_pair01_bf16 = arith.truncf %ep_v247_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v247_pair23_vec0 = vector.broadcast %ep_v247_row2 : f32 to vector<2xf32>
        %ep_v247_pair23_vec  = vector.insert %ep_v247_row3, %ep_v247_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v247_pair23_bf16 = arith.truncf %ep_v247_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v247_pair01_i32_v1i32 = vector.bitcast %ep_v247_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v247_pair01_i32 = vector.extract %ep_v247_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v247_pair23_i32_v1i32 = vector.bitcast %ep_v247_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v247_pair23_i32 = vector.extract %ep_v247_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v247_pair01_nbr, %ep_v247_pair01_valid = gpu.shuffle xor %ep_v247_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v247_pair23_nbr, %ep_v247_pair23_valid = gpu.shuffle xor %ep_v247_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v247_src_lo = arith.select %ep_is_even, %ep_v247_pair01_i32, %ep_v247_pair23_nbr : i32
        %ep_v247_src_hi = arith.select %ep_is_even, %ep_v247_pair01_nbr, %ep_v247_pair23_i32 : i32
        %ep_v247_sa_lo   = arith.andi %ep_v247_src_lo, %ep_c_0xFFFF : i32
        %ep_v247_sa_hi16 = arith.andi %ep_v247_src_hi, %ep_c_0xFFFF : i32
        %ep_v247_sa_hi   = arith.shli %ep_v247_sa_hi16, %ep_c_16 : i32
        %ep_v247_store_a_i32 = arith.ori %ep_v247_sa_lo, %ep_v247_sa_hi : i32
        %ep_v247_sb_lo = arith.shrui %ep_v247_src_lo, %ep_c_16 : i32
        %ep_v247_sb_hi = arith.andi %ep_v247_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v247_store_b_i32 = arith.ori %ep_v247_sb_lo, %ep_v247_sb_hi : i32
        %ep_v247_store_a_v1i32 = vector.broadcast %ep_v247_store_a_i32 : i32 to vector<1xi32>
        %ep_v247_store_a = vector.bitcast %ep_v247_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v247_store_b_v1i32 = vector.broadcast %ep_v247_store_b_i32 : i32 to vector<1xi32>
        %ep_v247_store_b = vector.bitcast %ep_v247_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v249_pair01_vec0 = vector.broadcast %ep_v249_row0 : f32 to vector<2xf32>
        %ep_v249_pair01_vec  = vector.insert %ep_v249_row1, %ep_v249_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v249_pair01_bf16 = arith.truncf %ep_v249_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v249_pair23_vec0 = vector.broadcast %ep_v249_row2 : f32 to vector<2xf32>
        %ep_v249_pair23_vec  = vector.insert %ep_v249_row3, %ep_v249_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v249_pair23_bf16 = arith.truncf %ep_v249_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v249_pair01_i32_v1i32 = vector.bitcast %ep_v249_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v249_pair01_i32 = vector.extract %ep_v249_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v249_pair23_i32_v1i32 = vector.bitcast %ep_v249_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v249_pair23_i32 = vector.extract %ep_v249_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v249_pair01_nbr, %ep_v249_pair01_valid = gpu.shuffle xor %ep_v249_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v249_pair23_nbr, %ep_v249_pair23_valid = gpu.shuffle xor %ep_v249_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v249_src_lo = arith.select %ep_is_even, %ep_v249_pair01_i32, %ep_v249_pair23_nbr : i32
        %ep_v249_src_hi = arith.select %ep_is_even, %ep_v249_pair01_nbr, %ep_v249_pair23_i32 : i32
        %ep_v249_sa_lo   = arith.andi %ep_v249_src_lo, %ep_c_0xFFFF : i32
        %ep_v249_sa_hi16 = arith.andi %ep_v249_src_hi, %ep_c_0xFFFF : i32
        %ep_v249_sa_hi   = arith.shli %ep_v249_sa_hi16, %ep_c_16 : i32
        %ep_v249_store_a_i32 = arith.ori %ep_v249_sa_lo, %ep_v249_sa_hi : i32
        %ep_v249_sb_lo = arith.shrui %ep_v249_src_lo, %ep_c_16 : i32
        %ep_v249_sb_hi = arith.andi %ep_v249_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v249_store_b_i32 = arith.ori %ep_v249_sb_lo, %ep_v249_sb_hi : i32
        %ep_v249_store_a_v1i32 = vector.broadcast %ep_v249_store_a_i32 : i32 to vector<1xi32>
        %ep_v249_store_a = vector.bitcast %ep_v249_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v249_store_b_v1i32 = vector.broadcast %ep_v249_store_b_i32 : i32 to vector<1xi32>
        %ep_v249_store_b = vector.bitcast %ep_v249_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v251_pair01_vec0 = vector.broadcast %ep_v251_row0 : f32 to vector<2xf32>
        %ep_v251_pair01_vec  = vector.insert %ep_v251_row1, %ep_v251_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v251_pair01_bf16 = arith.truncf %ep_v251_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v251_pair23_vec0 = vector.broadcast %ep_v251_row2 : f32 to vector<2xf32>
        %ep_v251_pair23_vec  = vector.insert %ep_v251_row3, %ep_v251_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v251_pair23_bf16 = arith.truncf %ep_v251_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v251_pair01_i32_v1i32 = vector.bitcast %ep_v251_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v251_pair01_i32 = vector.extract %ep_v251_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v251_pair23_i32_v1i32 = vector.bitcast %ep_v251_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v251_pair23_i32 = vector.extract %ep_v251_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v251_pair01_nbr, %ep_v251_pair01_valid = gpu.shuffle xor %ep_v251_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v251_pair23_nbr, %ep_v251_pair23_valid = gpu.shuffle xor %ep_v251_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v251_src_lo = arith.select %ep_is_even, %ep_v251_pair01_i32, %ep_v251_pair23_nbr : i32
        %ep_v251_src_hi = arith.select %ep_is_even, %ep_v251_pair01_nbr, %ep_v251_pair23_i32 : i32
        %ep_v251_sa_lo   = arith.andi %ep_v251_src_lo, %ep_c_0xFFFF : i32
        %ep_v251_sa_hi16 = arith.andi %ep_v251_src_hi, %ep_c_0xFFFF : i32
        %ep_v251_sa_hi   = arith.shli %ep_v251_sa_hi16, %ep_c_16 : i32
        %ep_v251_store_a_i32 = arith.ori %ep_v251_sa_lo, %ep_v251_sa_hi : i32
        %ep_v251_sb_lo = arith.shrui %ep_v251_src_lo, %ep_c_16 : i32
        %ep_v251_sb_hi = arith.andi %ep_v251_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v251_store_b_i32 = arith.ori %ep_v251_sb_lo, %ep_v251_sb_hi : i32
        %ep_v251_store_a_v1i32 = vector.broadcast %ep_v251_store_a_i32 : i32 to vector<1xi32>
        %ep_v251_store_a = vector.bitcast %ep_v251_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v251_store_b_v1i32 = vector.broadcast %ep_v251_store_b_i32 : i32 to vector<1xi32>
        %ep_v251_store_b = vector.bitcast %ep_v251_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v253_pair01_vec0 = vector.broadcast %ep_v253_row0 : f32 to vector<2xf32>
        %ep_v253_pair01_vec  = vector.insert %ep_v253_row1, %ep_v253_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v253_pair01_bf16 = arith.truncf %ep_v253_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v253_pair23_vec0 = vector.broadcast %ep_v253_row2 : f32 to vector<2xf32>
        %ep_v253_pair23_vec  = vector.insert %ep_v253_row3, %ep_v253_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v253_pair23_bf16 = arith.truncf %ep_v253_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v253_pair01_i32_v1i32 = vector.bitcast %ep_v253_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v253_pair01_i32 = vector.extract %ep_v253_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v253_pair23_i32_v1i32 = vector.bitcast %ep_v253_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v253_pair23_i32 = vector.extract %ep_v253_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v253_pair01_nbr, %ep_v253_pair01_valid = gpu.shuffle xor %ep_v253_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v253_pair23_nbr, %ep_v253_pair23_valid = gpu.shuffle xor %ep_v253_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v253_src_lo = arith.select %ep_is_even, %ep_v253_pair01_i32, %ep_v253_pair23_nbr : i32
        %ep_v253_src_hi = arith.select %ep_is_even, %ep_v253_pair01_nbr, %ep_v253_pair23_i32 : i32
        %ep_v253_sa_lo   = arith.andi %ep_v253_src_lo, %ep_c_0xFFFF : i32
        %ep_v253_sa_hi16 = arith.andi %ep_v253_src_hi, %ep_c_0xFFFF : i32
        %ep_v253_sa_hi   = arith.shli %ep_v253_sa_hi16, %ep_c_16 : i32
        %ep_v253_store_a_i32 = arith.ori %ep_v253_sa_lo, %ep_v253_sa_hi : i32
        %ep_v253_sb_lo = arith.shrui %ep_v253_src_lo, %ep_c_16 : i32
        %ep_v253_sb_hi = arith.andi %ep_v253_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v253_store_b_i32 = arith.ori %ep_v253_sb_lo, %ep_v253_sb_hi : i32
        %ep_v253_store_a_v1i32 = vector.broadcast %ep_v253_store_a_i32 : i32 to vector<1xi32>
        %ep_v253_store_a = vector.bitcast %ep_v253_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v253_store_b_v1i32 = vector.broadcast %ep_v253_store_b_i32 : i32 to vector<1xi32>
        %ep_v253_store_b = vector.bitcast %ep_v253_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
        ...
        %ep_v255_pair01_vec0 = vector.broadcast %ep_v255_row0 : f32 to vector<2xf32>
        %ep_v255_pair01_vec  = vector.insert %ep_v255_row1, %ep_v255_pair01_vec0 [1] : f32 into vector<2xf32>
        %ep_v255_pair01_bf16 = arith.truncf %ep_v255_pair01_vec : vector<2xf32> to vector<2xbf16>
        %ep_v255_pair23_vec0 = vector.broadcast %ep_v255_row2 : f32 to vector<2xf32>
        %ep_v255_pair23_vec  = vector.insert %ep_v255_row3, %ep_v255_pair23_vec0 [1] : f32 into vector<2xf32>
        %ep_v255_pair23_bf16 = arith.truncf %ep_v255_pair23_vec : vector<2xf32> to vector<2xbf16>
        %ep_v255_pair01_i32_v1i32 = vector.bitcast %ep_v255_pair01_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v255_pair01_i32 = vector.extract %ep_v255_pair01_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v255_pair23_i32_v1i32 = vector.bitcast %ep_v255_pair23_bf16 : vector<2xbf16> to vector<1xi32>
        %ep_v255_pair23_i32 = vector.extract %ep_v255_pair23_i32_v1i32[0] : i32 from vector<1xi32>
        %ep_v255_pair01_nbr, %ep_v255_pair01_valid = gpu.shuffle xor %ep_v255_pair01_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v255_pair23_nbr, %ep_v255_pair23_valid = gpu.shuffle xor %ep_v255_pair23_i32, %ep_shuffle_offset, %ep_shuffle_width : i32
        %ep_v255_src_lo = arith.select %ep_is_even, %ep_v255_pair01_i32, %ep_v255_pair23_nbr : i32
        %ep_v255_src_hi = arith.select %ep_is_even, %ep_v255_pair01_nbr, %ep_v255_pair23_i32 : i32
        %ep_v255_sa_lo   = arith.andi %ep_v255_src_lo, %ep_c_0xFFFF : i32
        %ep_v255_sa_hi16 = arith.andi %ep_v255_src_hi, %ep_c_0xFFFF : i32
        %ep_v255_sa_hi   = arith.shli %ep_v255_sa_hi16, %ep_c_16 : i32
        %ep_v255_store_a_i32 = arith.ori %ep_v255_sa_lo, %ep_v255_sa_hi : i32
        %ep_v255_sb_lo = arith.shrui %ep_v255_src_lo, %ep_c_16 : i32
        %ep_v255_sb_hi = arith.andi %ep_v255_src_hi, %ep_c_0xFFFF0000 : i32
        %ep_v255_store_b_i32 = arith.ori %ep_v255_sb_lo, %ep_v255_sb_hi : i32
        %ep_v255_store_a_v1i32 = vector.broadcast %ep_v255_store_a_i32 : i32 to vector<1xi32>
        %ep_v255_store_a = vector.bitcast %ep_v255_store_a_v1i32 : vector<1xi32> to vector<2xbf16>
        %ep_v255_store_b_v1i32 = vector.broadcast %ep_v255_store_b_i32 : i32 to vector<1xi32>
        %ep_v255_store_b = vector.bitcast %ep_v255_store_b_v1i32 : vector<1xi32> to vector<2xbf16>
