...
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 * 262144 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8) floordiv 256) * 262144)>
#map4 = affine_map<()[s0, s1] -> (s1 * 32 + (s0 floordiv 64) * 8 - ((s1 * 4 + s0 floordiv 64 + 8) floordiv 32) * 256 + 64)>
#map5 = affine_map<()[s0, s1, s2, s3] -> (s0 * 262144 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 64) floordiv 256) * 262144 + 65536)>
#map6 = affine_map<()[s0, s1] -> (s1 * 32 + (s0 floordiv 64) * 8 - ((s1 * 4 + s0 floordiv 64 + 16) floordiv 32) * 256 + 128)>
#map7 = affine_map<()[s0, s1, s2, s3] -> (s0 * 262144 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 128) floordiv 256) * 262144 + 131072)>
#map8 = affine_map<()[s0, s1] -> (s1 * 32 + (s0 floordiv 64) * 8 - ((s1 * 4 + s0 floordiv 64 + 24) floordiv 32) * 256 + 192)>
#map9 = affine_map<()[s0, s1, s2, s3] -> (s0 * 262144 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 192) floordiv 256) * 262144 + 196608)>
#map10 = affine_map<()[s0, s1] -> (s0 * 16384 + s1 * 4 + (s1 floordiv 64) * 4096 + ((s1 mod 64) floordiv 16) * 64 - (s1 floordiv 16) * 64)>
#map11 = affine_map<()[s0, s1] -> (s0 * 16384 + s1 * 4 + (s1 floordiv 64) * 4096 + ((s1 mod 64) floordiv 16) * 64 - (s1 floordiv 16) * 64 + 2048)>
#map12 = affine_map<()[s0, s1, s2] -> (s0 * 16384 + s1 * 8192 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64)>
#map13 = affine_map<()[s0, s1, s2] -> (s0 * 16384 + s1 * 8192 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64 + 2048)>
#map14 = affine_map<()[s0, s1, s2] -> (s0 * 16384 + s1 * 8192 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64 + 4096)>
#map15 = affine_map<()[s0, s1, s2] -> (s0 * 16384 + s1 * 8192 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64 + 6144)>
...
#map31 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 * 262144 + s1 * 32768 + s3 * 128 + s4 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8) floordiv 256) * 262144 + 128)>
#map32 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 * 262144 + s1 * 32768 + s3 * 128 + s4 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 64) floordiv 256) * 262144 + 65664)>
#map33 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 * 262144 + s1 * 32768 + s3 * 128 + s4 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 128) floordiv 256) * 262144 + 131200)>
#map34 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 * 262144 + s1 * 32768 + s3 * 128 + s4 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 192) floordiv 256) * 262144 + 196736)>
#map35 = affine_map<()[s0, s1, s2] -> (s0 * 16384 + s1 * 4 + s2 * 256 + (s1 floordiv 64) * 4096 + ((s1 mod 64) floordiv 16) * 64 - (s1 floordiv 16) * 64 + 256)>
#map36 = affine_map<()[s0, s1, s2] -> (s0 * 16384 + s1 * 4 + s2 * 256 + (s1 floordiv 64) * 4096 + ((s1 mod 64) floordiv 16) * 64 - (s1 floordiv 16) * 64 + 2304)>
#map37 = affine_map<()[s0, s1, s2, s3] -> (s0 * 16384 + s1 * 8192 + s2 * 256 + s3 * 4 + ((s3 mod 64) floordiv 16) * 64 - (s3 floordiv 16) * 64 + 256)>
#map38 = affine_map<()[s0, s1, s2, s3] -> (s0 * 16384 + s1 * 8192 + s2 * 256 + s3 * 4 + ((s3 mod 64) floordiv 16) * 64 - (s3 floordiv 16) * 64 + 2304)>
#map39 = affine_map<()[s0, s1, s2, s3] -> (s0 * 16384 + s1 * 8192 + s2 * 256 + s3 * 4 + ((s3 mod 64) floordiv 16) * 64 - (s3 floordiv 16) * 64 + 4352)>
#map40 = affine_map<()[s0, s1, s2, s3] -> (s0 * 16384 + s1 * 8192 + s2 * 256 + s3 * 4 + ((s3 mod 64) floordiv 16) * 64 - (s3 floordiv 16) * 64 + 6400)>
#map41 = affine_map<()[s0, s1, s2, s3] -> (s0 * 262144 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8) floordiv 256) * 262144 + 896)>
#map42 = affine_map<()[s0, s1, s2, s3] -> (s0 * 262144 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 64) floordiv 256) * 262144 + 66432)>
#map43 = affine_map<()[s0, s1, s2, s3] -> (s0 * 262144 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 128) floordiv 256) * 262144 + 131968)>
#map44 = affine_map<()[s0, s1, s2, s3] -> (s0 * 262144 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 192) floordiv 256) * 262144 + 197504)>
#map45 = affine_map<()[s0, s1] -> (s0 * 16384 + s1 * 4 + (s1 floordiv 64) * 4096 + ((s1 mod 64) floordiv 16) * 64 - (s1 floordiv 16) * 64 + 1792)>
#map46 = affine_map<()[s0, s1] -> (s0 * 16384 + s1 * 4 + (s1 floordiv 64) * 4096 + ((s1 mod 64) floordiv 16) * 64 - (s1 floordiv 16) * 64 + 3840)>
#map47 = affine_map<()[s0, s1, s2] -> (s0 * 16384 + s1 * 8192 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64 + 1792)>
#map48 = affine_map<()[s0, s1, s2] -> (s0 * 16384 + s1 * 8192 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64 + 3840)>
#map49 = affine_map<()[s0, s1, s2] -> (s0 * 16384 + s1 * 8192 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64 + 5888)>
#map50 = affine_map<()[s0, s1, s2] -> (s0 * 16384 + s1 * 8192 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64 + 7936)>
