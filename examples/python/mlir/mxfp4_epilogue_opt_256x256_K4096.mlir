...
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 * 524288 + s1 * 65536 + s3 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8) floordiv 256) * 524288)>
#map4 = affine_map<()[s0, s1] -> (s1 * 32 + (s0 floordiv 64) * 8 - ((s1 * 4 + s0 floordiv 64 + 8) floordiv 32) * 256 + 64)>
#map5 = affine_map<()[s0, s1, s2, s3] -> (s0 * 524288 + s1 * 65536 + s3 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8 + 64) floordiv 256) * 524288 + 131072)>
#map6 = affine_map<()[s0, s1] -> (s1 * 32 + (s0 floordiv 64) * 8 - ((s1 * 4 + s0 floordiv 64 + 16) floordiv 32) * 256 + 128)>
#map7 = affine_map<()[s0, s1, s2, s3] -> (s0 * 524288 + s1 * 65536 + s3 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8 + 128) floordiv 256) * 524288 + 262144)>
#map8 = affine_map<()[s0, s1] -> (s1 * 32 + (s0 floordiv 64) * 8 - ((s1 * 4 + s0 floordiv 64 + 24) floordiv 32) * 256 + 192)>
#map9 = affine_map<()[s0, s1, s2, s3] -> (s0 * 524288 + s1 * 65536 + s3 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8 + 192) floordiv 256) * 524288 + 393216)>
#map10 = affine_map<()[s0, s1] -> (s0 * 32768 + s1 * 4 + (s1 floordiv 64) * 8192 - (s1 floordiv 16) * 64 + ((s1 mod 64) floordiv 16) * 64)>
#map11 = affine_map<()[s0, s1] -> (s0 * 32768 + s1 * 4 + (s1 floordiv 64) * 8192 - (s1 floordiv 16) * 64 + ((s1 mod 64) floordiv 16) * 64 + 4096)>
#map12 = affine_map<()[s0, s1, s2] -> (s0 * 32768 + s1 * 16384 + s2 * 4 - (s2 floordiv 16) * 64 + ((s2 mod 64) floordiv 16) * 64)>
#map13 = affine_map<()[s0, s1, s2] -> (s0 * 32768 + s1 * 16384 + s2 * 4 - (s2 floordiv 16) * 64 + ((s2 mod 64) floordiv 16) * 64 + 4096)>
#map14 = affine_map<()[s0, s1, s2] -> (s0 * 32768 + s1 * 16384 + s2 * 4 - (s2 floordiv 16) * 64 + ((s2 mod 64) floordiv 16) * 64 + 8192)>
#map15 = affine_map<()[s0, s1, s2] -> (s0 * 32768 + s1 * 16384 + s2 * 4 - (s2 floordiv 16) * 64 + ((s2 mod 64) floordiv 16) * 64 + 12288)>
...
#map31 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 * 524288 + s1 * 65536 + s3 * 128 + s4 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8) floordiv 256) * 524288 + 128)>
#map32 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 * 524288 + s1 * 65536 + s3 * 128 + s4 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8 + 64) floordiv 256) * 524288 + 131200)>
#map33 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 * 524288 + s1 * 65536 + s3 * 128 + s4 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8 + 128) floordiv 256) * 524288 + 262272)>
#map34 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 * 524288 + s1 * 65536 + s3 * 128 + s4 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8 + 192) floordiv 256) * 524288 + 393344)>
#map35 = affine_map<()[s0, s1, s2] -> (s0 * 32768 + s1 * 4 + s2 * 256 + (s1 floordiv 64) * 8192 - (s1 floordiv 16) * 64 + ((s1 mod 64) floordiv 16) * 64 + 256)>
#map36 = affine_map<()[s0, s1, s2] -> (s0 * 32768 + s1 * 4 + s2 * 256 + (s1 floordiv 64) * 8192 - (s1 floordiv 16) * 64 + ((s1 mod 64) floordiv 16) * 64 + 4352)>
#map37 = affine_map<()[s0, s1, s2, s3] -> (s0 * 32768 + s1 * 16384 + s2 * 256 + s3 * 4 - (s3 floordiv 16) * 64 + ((s3 mod 64) floordiv 16) * 64 + 256)>
#map38 = affine_map<()[s0, s1, s2, s3] -> (s0 * 32768 + s1 * 16384 + s2 * 256 + s3 * 4 - (s3 floordiv 16) * 64 + ((s3 mod 64) floordiv 16) * 64 + 4352)>
#map39 = affine_map<()[s0, s1, s2, s3] -> (s0 * 32768 + s1 * 16384 + s2 * 256 + s3 * 4 - (s3 floordiv 16) * 64 + ((s3 mod 64) floordiv 16) * 64 + 8448)>
#map40 = affine_map<()[s0, s1, s2, s3] -> (s0 * 32768 + s1 * 16384 + s2 * 256 + s3 * 4 - (s3 floordiv 16) * 64 + ((s3 mod 64) floordiv 16) * 64 + 12544)>
#map41 = affine_map<()[s0, s1, s2, s3] -> (s0 * 524288 + s1 * 65536 + s3 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8) floordiv 256) * 524288 + 1920)>
#map42 = affine_map<()[s0, s1, s2, s3] -> (s0 * 524288 + s1 * 65536 + s3 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8 + 64) floordiv 256) * 524288 + 132992)>
#map43 = affine_map<()[s0, s1, s2, s3] -> (s0 * 524288 + s1 * 65536 + s3 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8 + 128) floordiv 256) * 524288 + 264064)>
#map44 = affine_map<()[s0, s1, s2, s3] -> (s0 * 524288 + s1 * 65536 + s3 * 16 + (s2 floordiv 8) * 2048 - ((s1 * 32 + s2 floordiv 8 + 192) floordiv 256) * 524288 + 395136)>
#map45 = affine_map<()[s0, s1] -> (s0 * 32768 + s1 * 4 + (s1 floordiv 64) * 8192 - (s1 floordiv 16) * 64 + ((s1 mod 64) floordiv 16) * 64 + 3840)>
#map46 = affine_map<()[s0, s1] -> (s0 * 32768 + s1 * 4 + (s1 floordiv 64) * 8192 - (s1 floordiv 16) * 64 + ((s1 mod 64) floordiv 16) * 64 + 7936)>
#map47 = affine_map<()[s0, s1, s2] -> (s0 * 32768 + s1 * 16384 + s2 * 4 - (s2 floordiv 16) * 64 + ((s2 mod 64) floordiv 16) * 64 + 3840)>
#map48 = affine_map<()[s0, s1, s2] -> (s0 * 32768 + s1 * 16384 + s2 * 4 - (s2 floordiv 16) * 64 + ((s2 mod 64) floordiv 16) * 64 + 7936)>
#map49 = affine_map<()[s0, s1, s2] -> (s0 * 32768 + s1 * 16384 + s2 * 4 - (s2 floordiv 16) * 64 + ((s2 mod 64) floordiv 16) * 64 + 12032)>
#map50 = affine_map<()[s0, s1, s2] -> (s0 * 32768 + s1 * 16384 + s2 * 4 - (s2 floordiv 16) * 64 + ((s2 mod 64) floordiv 16) * 64 + 16128)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding, %arg3: !stream.binding, %arg4: !stream.binding, %arg5: index, %arg6: index, %arg7: index, %arg8: index, %arg9: index) attributes {translation_info = #translation} {
        ...
        %c128_i14 = arith.constant 128 : i14
        %c2048_i14 = arith.constant 2048 : i14
        ...
        %12 = amdgpu.fat_raw_buffer_cast %cast validBytes(%c2097152_i64) cacheSwizzleStride(%c2048_i14) resetOffset : memref<?xi8, strided<[1], offset: ?>> to memref<?xi8, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %23 = amdgpu.fat_raw_buffer_cast %cast_5 validBytes(%c2097152_i64) cacheSwizzleStride(%c2048_i14) resetOffset : memref<?xi8, strided<[1], offset: ?>> to memref<?xi8, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %27 = amdgpu.fat_raw_buffer_cast %cast_7 validBytes(%c131072_i64) cacheSwizzleStride(%c128_i14) resetOffset : memref<?xi8, strided<[1], offset: ?>> to memref<?xi8, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %32 = amdgpu.fat_raw_buffer_cast %cast_9 validBytes(%c131072_i64) cacheSwizzleStride(%c128_i14) resetOffset : memref<?xi8, strided<[1], offset: ?>> to memref<?xi8, #amdgpu.address_space<fat_raw_buffer>>
  ...
  func.func @isolated_benchmark$async(%arg0: !hal.buffer_view, %arg1: !hal.buffer_view, %arg2: !hal.buffer_view, %arg3: !hal.buffer_view, %arg4: !hal.buffer_view, %arg5: index, %arg6: index, %arg7: index, %arg8: index, %arg9: index, %arg10: !hal.fence, %arg11: !hal.fence) -> !hal.buffer_view {
    %0 = hal.tensor.import wait(%arg10) => %arg0 : !hal.buffer_view -> tensor<1024x2048xi8>
    %1 = hal.tensor.import wait(%arg10) => %arg1 : !hal.buffer_view -> tensor<1024x128xi8>
    %2 = hal.tensor.import wait(%arg10) => %arg2 : !hal.buffer_view -> tensor<1024x2048xi8>
    %3 = hal.tensor.import wait(%arg10) => %arg3 : !hal.buffer_view -> tensor<1024x128xi8>
    %4 = hal.tensor.import wait(%arg10) => %arg4 : !hal.buffer_view -> tensor<1024x1024xbf16>
    %5 = flow.dispatch @gemm::@gemm[%arg5, %arg6, %arg7, %arg8, %arg9](%0, %1, %2, %3, %4, %arg5, %arg6, %arg7, %arg8, %arg9) : (tensor<1024x2048xi8>, tensor<1024x128xi8>, tensor<1024x2048xi8>, tensor<1024x128xi8>, tensor<1024x1024xbf16>, index, index, index, index, index) -> %4
