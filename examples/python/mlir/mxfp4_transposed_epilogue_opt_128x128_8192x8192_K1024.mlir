  ...
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding, %arg3: !stream.binding, %arg4: !stream.binding, %arg5: index, %arg6: index, %arg7: index, %arg8: index, %arg9: index) attributes {translation_info = #translation} {
        ...
        %c65536_i64 = arith.constant 262144 : i64
        %c1048576_i64 = arith.constant 4194304 : i64
        ...
        %tp_blkr = affine.apply #map33()[%block_id_y]
        %tp_blkc = affine.apply #map33()[%block_id_x]
        ...
        %tp_mbase = affine.apply #map35()[%thread_id_x, %thread_id_y]
        ...
        // === Pair 0 (rb0,col0-col1): %234, %236 ===
        %v234_b16 = arith.truncf %234 : vector<4xf32> to vector<4xbf16>
        %v236_b16 = arith.truncf %236 : vector<4xf32> to vector<4xbf16>
        %tp0_a01v = vector.extract_strided_slice %v234_b16 {offsets = [0], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        %tp0_a23v = vector.extract_strided_slice %v234_b16 {offsets = [2], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        ...
        %tp0_b01v = vector.extract_strided_slice %v236_b16 {offsets = [0], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        %tp0_b23v = vector.extract_strided_slice %v236_b16 {offsets = [2], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        ...
        // === Pair 1 (rb0,col2-col3): %238, %240 ===
        %v238_b16 = arith.truncf %238 : vector<4xf32> to vector<4xbf16>
        %v240_b16 = arith.truncf %240 : vector<4xf32> to vector<4xbf16>
        %tp1_a01v = vector.extract_strided_slice %v238_b16 {offsets = [0], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        %tp1_a23v = vector.extract_strided_slice %v238_b16 {offsets = [2], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        ...
        %tp1_b01v = vector.extract_strided_slice %v240_b16 {offsets = [0], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        %tp1_b23v = vector.extract_strided_slice %v240_b16 {offsets = [2], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        ...
        // === Pair 2 (rb1,col0-col1): %242, %244 ===
        %v242_b16 = arith.truncf %242 : vector<4xf32> to vector<4xbf16>
        %v244_b16 = arith.truncf %244 : vector<4xf32> to vector<4xbf16>
        %tp2_a01v = vector.extract_strided_slice %v242_b16 {offsets = [0], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        %tp2_a23v = vector.extract_strided_slice %v242_b16 {offsets = [2], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        ...
        %tp2_b01v = vector.extract_strided_slice %v244_b16 {offsets = [0], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        %tp2_b23v = vector.extract_strided_slice %v244_b16 {offsets = [2], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        ...
        // === Pair 3 (rb1,col2-col3): %246, %248 ===
        %v246_b16 = arith.truncf %246 : vector<4xf32> to vector<4xbf16>
        %v248_b16 = arith.truncf %248 : vector<4xf32> to vector<4xbf16>
        %tp3_a01v = vector.extract_strided_slice %v246_b16 {offsets = [0], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        %tp3_a23v = vector.extract_strided_slice %v246_b16 {offsets = [2], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        ...
        %tp3_b01v = vector.extract_strided_slice %v248_b16 {offsets = [0], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
        %tp3_b23v = vector.extract_strided_slice %v248_b16 {offsets = [2], sizes = [2], strides = [1]} : vector<4xbf16> to vector<2xbf16>
