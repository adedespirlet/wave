...
#map3 = affine_map<()[s0, s1, s2, s3] -> (s0 * 131072 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8) floordiv 128) * 131072)>
#map4 = affine_map<()[s0, s1] -> (s1 * 32 + (s0 floordiv 64) * 8 - ((s1 * 4 + s0 floordiv 64 + 8) floordiv 16) * 128 + 64)>
#map5 = affine_map<()[s0, s1, s2, s3] -> (s0 * 131072 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 64) floordiv 128) * 131072 + 65536)>
#map6 = affine_map<()[s0, s1] -> (s0 * 8192 + s1 * 4 + (s1 floordiv 64) * 2048 + ((s1 mod 64) floordiv 16) * 64 - (s1 floordiv 16) * 64)>
#map7 = affine_map<()[s0, s1, s2] -> (s0 * 8192 + s1 * 4096 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64)>
#map8 = affine_map<()[s0, s1, s2] -> (s0 * 8192 + s1 * 4096 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64 + 2048)>
...
#map18 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 * 131072 + s1 * 32768 + s3 * 128 + s4 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8) floordiv 128) * 131072 + 128)>
#map19 = affine_map<()[s0, s1, s2, s3, s4] -> (s0 * 131072 + s1 * 32768 + s3 * 128 + s4 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 64) floordiv 128) * 131072 + 65664)>
#map20 = affine_map<()[s0, s1, s2] -> (s0 * 8192 + s1 * 4 + s2 * 256 + (s1 floordiv 64) * 2048 + ((s1 mod 64) floordiv 16) * 64 - (s1 floordiv 16) * 64 + 256)>
#map21 = affine_map<()[s0, s1, s2, s3] -> (s0 * 8192 + s1 * 4096 + s2 * 256 + s3 * 4 + ((s3 mod 64) floordiv 16) * 64 - (s3 floordiv 16) * 64 + 256)>
#map22 = affine_map<()[s0, s1, s2, s3] -> (s0 * 8192 + s1 * 4096 + s2 * 256 + s3 * 4 + ((s3 mod 64) floordiv 16) * 64 - (s3 floordiv 16) * 64 + 2304)>
#map23 = affine_map<()[s0, s1, s2, s3] -> (s0 * 131072 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8) floordiv 128) * 131072 + 896)>
#map24 = affine_map<()[s0, s1, s2, s3] -> (s0 * 131072 + s1 * 32768 + s3 * 16 + (s2 floordiv 8) * 1024 - ((s1 * 32 + s2 floordiv 8 + 64) floordiv 128) * 131072 + 66432)>
#map25 = affine_map<()[s0, s1] -> (s0 * 8192 + s1 * 4 + (s1 floordiv 64) * 2048 + ((s1 mod 64) floordiv 16) * 64 - (s1 floordiv 16) * 64 + 1792)>
#map26 = affine_map<()[s0, s1, s2] -> (s0 * 8192 + s1 * 4096 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64 + 1792)>
#map27 = affine_map<()[s0, s1, s2] -> (s0 * 8192 + s1 * 4096 + s2 * 4 + ((s2 mod 64) floordiv 16) * 64 - (s2 floordiv 16) * 64 + 3840)>
...
module attributes {transform.with_named_sequence} {
  stream.executable private @gemm {
    ...
    builtin.module {
      func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding, %arg3: !stream.binding, %arg4: !stream.binding, %arg5: index, %arg6: index, %arg7: index, %arg8: index, %arg9: index) attributes {translation_info = #translation} {
        ...
        %12 = amdgpu.fat_raw_buffer_cast %cast validBytes(%c8388608_i64) cacheSwizzleStride(%c1024_i14) resetOffset : memref<?xi8, strided<[1], offset: ?>> to memref<?xi8, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %17 = amdgpu.fat_raw_buffer_cast %cast_5 validBytes(%c8388608_i64) cacheSwizzleStride(%c1024_i14) resetOffset : memref<?xi8, strided<[1], offset: ?>> to memref<?xi8, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %19 = amdgpu.fat_raw_buffer_cast %cast_7 validBytes(%c524288_i64) cacheSwizzleStride(%c64_i14) resetOffset : memref<?xi8, strided<[1], offset: ?>> to memref<?xi8, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %22 = amdgpu.fat_raw_buffer_cast %cast_9 validBytes(%c524288_i64) cacheSwizzleStride(%c64_i14) resetOffset : memref<?xi8, strided<[1], offset: ?>> to memref<?xi8, #amdgpu.address_space<fat_raw_buffer>>
        ...
        %47:11 = scf.for %arg10 = %c0 to %c6 step %c2 iter_args(%arg11 = %cst, %arg12 = %cst, %arg13 = %cst, %arg14 = %cst, %arg15 = %cst, %arg16 = %cst, %arg17 = %cst, %arg18 = %cst, %arg19 = %21, %arg20 = %24, %arg21 = %26) -> (vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xf32>, vector<4xi8>, vector<4xi8>, vector<4xi8>) {
  ...
  func.func @isolated_benchmark$async(%arg0: !hal.buffer_view, %arg1: !hal.buffer_view, %arg2: !hal.buffer_view, %arg3: !hal.buffer_view, %arg4: !hal.buffer_view, %arg5: index, %arg6: index, %arg7: index, %arg8: index, %arg9: index, %arg10: !hal.fence, %arg11: !hal.fence) -> !hal.buffer_view {
    %0 = hal.tensor.import wait(%arg10) => %arg0 : !hal.buffer_view -> tensor<8192x1024xi8>
    %1 = hal.tensor.import wait(%arg10) => %arg1 : !hal.buffer_view -> tensor<8192x64xi8>
    %2 = hal.tensor.import wait(%arg10) => %arg2 : !hal.buffer_view -> tensor<8192x1024xi8>
    %3 = hal.tensor.import wait(%arg10) => %arg3 : !hal.buffer_view -> tensor<8192x64xi8>
    %4 = hal.tensor.import wait(%arg10) => %arg4 : !hal.buffer_view -> tensor<8192x8192xbf16>
    %5 = flow.dispatch @gemm::@gemm[%arg5, %arg6, %arg7, %arg8, %arg9](%0, %1, %2, %3, %4, %arg5, %arg6, %arg7, %arg8, %arg9) : (tensor<8192x1024xi8>, tensor<8192x64xi8>, tensor<8192x1024xi8>, tensor<8192x64xi8>, tensor<8192x8192xbf16>, index, index, index, index, index) -> %4
